...
Все дальнейшие операции идут по комбинации accessToken и secretAccessToken, продлеваются автоматически. Так же нужно передать apiType со значением mobile
...
GET-запрос на /recommendation/:regionCode/ . Вместо :regionCode указываем или general для общих рекомендаций или код региона от 1 до 92. Можно указать код региона как с нулём в качестве первой цифры, так и без для регионов 1-9. 
...
```
{
  ...
  "status": "ok",
  "data": {
    "id": "5eb00efcf4ea4d003865d088",
    "uuid": "29fb4399-4b8a-42a8-8def-d8b3e60410db",
    "title": "Общие рекомендации",
    "excerpt": "Бла-бла всё хуйня",
    "html": [
      {
        "html": "<html><head></head><body><p>Бла-бла всё хуйня</p></body></html>"
      }
    ]
  }
}
